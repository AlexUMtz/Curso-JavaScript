export function ContactForm() {
  ...
  function validationsForm() {
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/alexxldalex@yahoo.com.mx", {
        method: "POST",
        ...
        .catch((err) => {
          console.log(err);
          let message =
            err.statusText || "Ocurrió un error el enviar, intenta nuevamente";
  ...
  //   Para evitar problemas en el renderizado
  //   necesitamos esperar a que se pinte o carge el HTML
  //   y una vez cargado, se ejecute la función
  setTimeout(() => {
    validationsForm();
  }, 100);
